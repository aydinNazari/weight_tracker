...
abstract class $RecordCopyWith<$Res> {
  ...
  @useResult
  $Res call({int weight, DateTime dateTime, String? imageUrl, String? note});
}
...
class _$_Record with DiagnosticableTreeMixin implements _Record {
  _$_Record(
      {required this.weight, required this.dateTime, this.imageUrl, this.note});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Record(weight: $weight, dateTime: $dateTime, imageUrl: $imageUrl, note: $note)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, weight, dateTime, imageUrl, note);
